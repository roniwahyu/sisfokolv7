...
Untuk mengaktifkan modularitas murni ini tanpa perlu melakukan pendaftaran manual di router global, sistem menggunakan **`app/Providers/ModuleServiceProvider.php`** yang secara otomatis melakukan *autowiring* sebagai berikut:
